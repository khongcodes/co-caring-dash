    ...
    <>
      ...
      <TextSection title='Mission Statement'>
        ...
        <p>To use the Co-Caring Dashboard, please scroll down for information about COVID-19 in your state and county. 
          <ul>
            <li>If you’re interested in joining or starting a co-caring project, such as supporting the elderly to shelter in place click on the Co-Caring Chat to connect with others. </li>
